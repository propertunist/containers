...
if (isset($vars['entity']) && $vars['entity'] instanceof ElggEntity) {
 ...
 $content = elgg_get_entities_from_relationship(array(
        'type' => 'group',
        'relationship' => 'member',
        'relationship_guid' => $entity_owner->getGUID(),
   ...
   // if (($page_owner->guid <> $logged_in_user->guid)&& ($page_owner instanceof ElggUser)){ // if the logged in user is not the page owning user, then add the page owning user as an option - for 'login as' plugin and admins.
